    ...
    async function fetchGhost() {
      try {
        ...
        if (error || !data) {
          ...
          // Merge Supabase data with rich mock data for wiki fields
    ...
    <div className="min-h-screen pb-32">
      <div className="max-w-6xl mx-auto px-6 pt-8">
        ...
        <div className="grid md:grid-cols-[1fr_1.1fr] gap-8 items-start mb-16">
          ...
          >
            {ghost.image_url ? (
              <Image src={ghost.image_url} alt={ghost.name} fill
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {/* Eyewitness reports — YouTube-style */}
            <div>

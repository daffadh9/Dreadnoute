...
const MOCK_GHOSTS = [
  { id: "1", name: "The Weeping Willow", rarity: "Common" as const, image_url: "", danger_lvl: 3, role: "Watcher" as const, price: { dc: 100, obsidian: 0 }, tags: [] },
  { id: "2", name: "Shadow Stalker", rarity: "Uncommon" as const, image_url: "", danger_lvl: 5, role: "Aggressor" as const, price: { dc: 250, obsidian: 0 }, tags: [] },
  { id: "3", name: "The Grinning Man", rarity: "Rare" as const, image_url: "", danger_lvl: 7, role: "Manipulator" as const, price: { dc: 500, obsidian: 1 }, tags: [] },
  { id: "4", name: "Bloody Mary", rarity: "Epic" as const, image_url: "", danger_lvl: 8, role: "Aggressor" as const, price: { dc: 1000, obsidian: 2 }, tags: [] },
  { id: "5", name: "The Pale Lady", rarity: "Legendary" as const, image_url: "", danger_lvl: 10, role: "Manipulator" as const, price: { dc: 2500, obsidian: 5 }, tags: [] },
  { id: "6", name: "Looming Mirror", rarity: "Common" as const, image_url: "", danger_lvl: 2, role: "Passive" as const, price: { dc: 100, obsidian: 0 }, tags: [] },
];
